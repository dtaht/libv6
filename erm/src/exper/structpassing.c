...
extern compound_struct_t R fool_compiler2(flags_t af, ip_addr av, flags_t bf, ip_addr bv);

extern ip_addr R fool_compiler3(flags_t af, ip_addr av, flags_t bf, ip_addr bv);

extern flags_t R fool_compiler4(flags_t af, ip_addr av, flags_t bf, ip_addr bv);

extern ip_addr R fool_compiler5(flags_t af, ip_addr av, flags_t bf, ip_addr bv);
...
#define TESTS1(n, a, b, result)                                              \
  result = fool_compiler##n(a, b);                                           \
  check_flags(r.f)
#define TESTS2(n, g, g1, k, k1, result)                                      \
  result = fool_compiler##n(g.f, g1.a, k.f, k1.a);                           \
  check_flags(r.f)
#define TESTS3(n, g, g1, k, k1, result)                                      \
  result = fool_compiler##n(g.f, g1, k.f, k1.a);                             \
  check_flags(r.f)
