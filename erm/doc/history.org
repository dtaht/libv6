...
32 bit virtual memory arches for a while, and would blithely do a
malloc(1024*1024) with nary a qualm or by-your-leave. All I could do
was look enviously on all that, although I was happy with nifty hooks
like "Sidekick" and "turbo lightning" that provided a great deal of
interactivity that those guys didn't have. I spent a crazy amount of
time porting code from those worlds into my 286 based Xenix platforms
and dealing with all the near and far pointers and memory models.
