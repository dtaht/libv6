...
/* FIXME: Since the concept of the hwrng is many - pulling from a different
   pool
          per functional unit is needed. Sometimes. Unless we do linker magic.
*/
...
/* My simplest implementation.
   ... except that get_cycles is slow, buggy, or unavailable on some
  processors.
   ...
   FIXME: I am also reminded of the time that get_cycles was indeed compiled
  out
